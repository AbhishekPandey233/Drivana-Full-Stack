...
import { createRenting, getMyRentings, extendRenting, decreaseRenting, cancelRenting, getAllRentings, adminCancelRenting, payRental } from "../controllers/rentingController";
...
router.post("/:id/pay", requireAuth, payRental);
