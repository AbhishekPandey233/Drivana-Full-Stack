...
import { MapPin, Car, CreditCard, Fuel, Snowflake, Settings } from 'lucide-react';
      ...
      <div className="w-full bg-white font-sans text-gray-900 pb-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          <div className="bg-[#6366F1] rounded-3xl p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between relative overflow-hidden text-white min-h-[500px]">
            ...
            <div className="max-w-xl z-10 space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight animate-fade-in-up">
                Experience the road like never before
              </h1>
              <p className="text-indigo-100 text-lg font-light max-w-md animate-fade-in-up stagger-1">
                Premium car rentals tailored exactly to your journey and your lifestyle choice.
              </p>
              {/* Changed from <button> to <Link> for navigation */}
              <Link
                href="/vehicles"
                className="bg-[#F59E0B] hover:bg-amber-600 text-white font-semibold px-6 py-3 rounded-xl transition-smooth-fast shadow-md hover:shadow-lg hover:scale-105 active:scale-95 inline-block text-center text-sm md:text-base animate-fade-in-up stagger-2"
              >
                View all cars
              </Link>
            </div>
            ...
            <div className="mt-8 lg:mt-0 w-full max-w-sm bg-white rounded-2xl p-6 text-gray-800 shadow-xl z-10 animate-scale-in stagger-1 transition-transform duration-300 hover:-translate-y-1">
              ...
              <form className="space-y-4" onSubmit={handleBookingSubmit}>
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-lg p-2.5 text-sm bg-gray-50 outline-none cursor-pointer transition-smooth-fast focus:ring-2 focus:ring-[#6366F1]/40 focus:border-[#6366F1]"
                  >
                ...
                <button type="submit" className="w-full bg-[#F59E0B] hover:bg-amber-600 text-white font-bold text-sm py-3 rounded-lg uppercase mt-4 transition-smooth-fast hover:shadow-lg active:scale-95">
                  Book now
                </button>
              </form>
            </div>
            ...
            <div className="absolute right-1/4 bottom-0 opacity-20 w-[500px] h-[300px] bg-gradient-to-tr from-cyan-400 to-blue-900 rounded-full blur-3xl pointer-events-none animate-fade-in" />
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 py-16 grid grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center space-y-2 animate-fade-in-up">
            <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-indigo-600 border border-gray-100 transition-smooth hover:scale-110 hover:shadow-[0_0_20px_rgba(99,102,241,0.35)] hover:bg-indigo-50"><MapPin className="w-5 h-5" strokeWidth={2.25} /></div>
            <span className="font-semibold text-sm">Availability</span>
          </div>
          <div className="flex flex-col items-center space-y-2 animate-fade-in-up stagger-1">
            <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-indigo-600 border border-gray-100 transition-smooth hover:scale-110 hover:shadow-[0_0_20px_rgba(99,102,241,0.35)] hover:bg-indigo-50"><Car className="w-5 h-5" strokeWidth={2.25} /></div>
            <span className="font-semibold text-sm">Comfort</span>
          </div>
          <div className="flex flex-col items-center space-y-2 animate-fade-in-up stagger-2">
            <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-indigo-600 border border-gray-100 transition-smooth hover:scale-110 hover:shadow-[0_0_20px_rgba(99,102,241,0.35)] hover:bg-indigo-50"><CreditCard className="w-5 h-5" strokeWidth={2.25} /></div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-50 rounded-3xl aspect-[4/3] w-full flex items-center justify-center border border-gray-100 shadow-sm overflow-hidden relative group">
            <Image
              src="/rollsroyce.jpg"
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={item.num} className={`flex gap-4 group animate-fade-in-up stagger-${idx + 1}`}>
                <div className="flex-shrink-0 w-8 h-8 bg-indigo-100 text-indigo-600 font-bold rounded-full flex items-center justify-center text-sm transition-smooth group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110">
                  {item.num}
                </div>
                <div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex justify-between items-end mb-8">
            ...
            <Link href="/vehicles" className="text-sm font-semibold text-gray-600 hover:text-indigo-600 transition-smooth-fast flex items-center gap-1 group">
              View All <span className="transition-transform duration-200 group-hover:translate-x-1">â†’</span>
            </Link>
          </div>
          ...
          <div className="bg-[#6366F1] rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {[
                ...
                <div key={idx} className={`card-hover-glow bg-white rounded-xl p-4 text-gray-900 flex flex-col items-center justify-center shadow-sm animate-fade-in-up stagger-${idx + 1}`}>
